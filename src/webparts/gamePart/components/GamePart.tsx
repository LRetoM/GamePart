...
import type { IGamePartProps } from './IGamePartProps';
import { escape } from '@microsoft/sp-lodash-subset';
import welcomeDark from '../assets/welcome-dark.png';
import welcomeLight from '../assets/welcome-light.png';

export default class GamePart extends React.Component<IGamePartProps> {
  public render(): React.ReactElement<IGamePartProps> {
    const {
      description,
      isDarkTheme,
      environmentMessage,
